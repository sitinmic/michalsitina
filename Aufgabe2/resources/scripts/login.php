...
if (isset($_SESSION['user_name'])) {
  ...
  header("location:tables_plots.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  background-size: auto;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="include/controller.php" class="login" method="post" enctype="multipart/form-data">
                  ...
                  <a class="collapse-item" href="tables_plots.php">Return to query page</a>
